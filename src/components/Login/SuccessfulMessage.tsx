...
const SuccessfulMessage = () => {
  ...
  return (
    ...
    <div className='absolute top-1/2 left-1/2 transform -translate-x-[50%] -translate-y-[50%] bg-white shadow-shadow_primary p-12 flex flex-col gap-[10px]'>
      <h1 className='font-bold md:text-xl text-lg text-center'>XÁC NHẬN THÀNH CÔNG!<br></br> BẠN CÓ THỂ XEM MẬT KHẨU Ở GMAIL!</h1>
      <div className='w-[200px] h-[200px] mx-auto my-8'>
      <img src={V} alt='img' className='w-full h-full object-fit'></img>
      </div>
      <Button variant="contained" type='submit' className='mx-auto my-8' style={{ backgroundColor: '#9A917A' }} onClick={handleNavigate}>Đăng nhập</Button>
    </div>
    </Overlay>}
    </div>
  )
