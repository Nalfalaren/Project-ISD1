        ...
        <form onSubmit={handleSubmit(onSubmit)} >
          <div className='flex md:flex-row flex-col justify-center align-center md:gap-[50px] gap-[10px] text-lg'>
            <div className='flex flex-col justify-center align-center gap-[10px] text-lg'>
              ...
              <TextField className='bg-login_input ' id="outlined-basic" placeholder='VD: Chu Minh' variant="outlined" type='text' {...register('full_name', { required: `${errors.full_name}` })} />
              {errors.full_name && (
                <span className='text-red-500 font-bold text-xs w-full'>{errors.full_name.message}</span>
              )}
              <label htmlFor='Email'>Email *</label>
              <TextField className='bg-login_input' id="filled-basic-email" placeholder="VD: 123@gmail.com" variant="outlined" type='text' {...register('email')} />
              ...
              <TextField className='bg-login_input' id="filled-basic-sdt" placeholder="VD: 0123455667" variant="outlined" type='text' {...register('phone_number')} />
            ...
            <div className='flex flex-col justify-center align-center gap-[10px] text-lg'>
              ...
              <div className='relative'>
                <TextField className='bg-login_input w-full' id="filled-basic-mk" placeholder="VD: 123456789" variant="outlined" type={click.clickVisibleSignUp ? 'text' : 'password'} {...register('password')} />
              ...
              <div className='relative'>
                <TextField className='bg-login_input w-full' id="filled-basic-cf" placeholder="VD: 123456789" variant="outlined" type={click.clickVisiblePasswordConfirm ? 'text' : 'password'} {...register('confirm_password')} />
              ...
              {errors.confirm_password && <span className='text-red-500 font-bold text-xs'>{errors.confirm_password.message}</span>}
            </div>
          </div>
